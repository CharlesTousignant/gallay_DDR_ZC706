...
HD_PWD='C:/Users/Projet/Desktop/Recherche/gallay_DDR_ZC706/workspace/AXI_DDR_ZC706/AXI_DDR_ZC706.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ddr_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_ddr_design_wrapper.tcl -notrace
