...
################################################################
# This is a generated script based on design: design_v3
#
...
# source design_v3_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# debounce, debounce_n, fsm_v3
...
proc write_mig_file_design_v3_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>design_v3_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_design_v3_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fsm_v3_0, and set properties
  set block_name fsm_v3
  set block_cell_name fsm_v3_0
  if { [catch {set fsm_v3_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fsm_v3_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  write_mig_file_design_v3_mig_7series_0_0 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M24_AXI [get_bd_intf_pins axi_gpio_24/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M24_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M25_AXI [get_bd_intf_pins axi_gpio_25/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M25_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M26_AXI [get_bd_intf_pins axi_gpio_26/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M26_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_wreq]
  connect_bd_net -net axi_gpio_10_gpio_io_o [get_bd_pins axi_gpio_10/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_rready]
  connect_bd_net -net axi_gpio_11_gpio_io_o [get_bd_pins axi_gpio_11/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_rack]
  connect_bd_net -net axi_gpio_12_gpio_io_o [get_bd_pins axi_gpio_12/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_araddr]
  connect_bd_net -net axi_gpio_13_gpio_io_o [get_bd_pins axi_gpio_13/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_arlen]
  connect_bd_net -net axi_gpio_14_gpio_io_o [get_bd_pins axi_gpio_14/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_arburst]
  connect_bd_net -net axi_gpio_15_gpio_io_o [get_bd_pins axi_gpio_15/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_rresp_ack]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_rreq]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_wvalid]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_wlast]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins axi_gpio_4/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_wack]
  connect_bd_net -net axi_gpio_5_gpio_io_o [get_bd_pins axi_gpio_5/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_awaddr]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins axi_gpio_6/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_wdata]
  connect_bd_net -net axi_gpio_7_gpio_io_o [get_bd_pins axi_gpio_7/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_awlen]
  connect_bd_net -net axi_gpio_8_gpio_io_o [get_bd_pins axi_gpio_8/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_awburst]
  connect_bd_net -net axi_gpio_9_gpio_io_o [get_bd_pins axi_gpio_9/gpio_io_o] [get_bd_pins fsm_v3_0/gpio_wresp_ack]
  connect_bd_net -net debounce_0_button_out [get_bd_pins debounce_0/button_out] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net debounce_n_0_button_out [get_bd_pins debounce_n_0/button_out] [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net fsm_v3_0_gpio_debug_state [get_bd_pins axi_gpio_23/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_debug_state]
  connect_bd_net -net fsm_v3_0_gpio_rdata [get_bd_pins axi_gpio_21/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_rdata]
  connect_bd_net -net fsm_v3_0_gpio_rresp [get_bd_pins axi_gpio_19/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_rresp]
  connect_bd_net -net fsm_v3_0_gpio_rresp_valid [get_bd_pins axi_gpio_22/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_rresp_valid]
  connect_bd_net -net fsm_v3_0_gpio_rvalid [get_bd_pins axi_gpio_20/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_rvalid]
  connect_bd_net -net fsm_v3_0_gpio_wfifo_ready [get_bd_pins axi_gpio_16/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_wfifo_ready]
  connect_bd_net -net fsm_v3_0_gpio_wresp [get_bd_pins axi_gpio_18/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_wresp]
  connect_bd_net -net fsm_v3_0_gpio_wresp_valid [get_bd_pins axi_gpio_17/gpio_io_i] [get_bd_pins fsm_v3_0/gpio_wresp_valid]
  connect_bd_net -net fsm_v3_0_s_axi_araddr [get_bd_pins fsm_v3_0/s_axi_araddr] [get_bd_pins mig_7series_0/s_axi_araddr]
  connect_bd_net -net fsm_v3_0_s_axi_arburst [get_bd_pins fsm_v3_0/s_axi_arburst] [get_bd_pins mig_7series_0/s_axi_arburst]
  connect_bd_net -net fsm_v3_0_s_axi_arcache [get_bd_pins fsm_v3_0/s_axi_arcache] [get_bd_pins mig_7series_0/s_axi_arcache]
  connect_bd_net -net fsm_v3_0_s_axi_arid [get_bd_pins fsm_v3_0/s_axi_arid] [get_bd_pins mig_7series_0/s_axi_arid]
  connect_bd_net -net fsm_v3_0_s_axi_arlen [get_bd_pins fsm_v3_0/s_axi_arlen] [get_bd_pins mig_7series_0/s_axi_arlen]
  connect_bd_net -net fsm_v3_0_s_axi_arlock [get_bd_pins fsm_v3_0/s_axi_arlock] [get_bd_pins mig_7series_0/s_axi_arlock]
  connect_bd_net -net fsm_v3_0_s_axi_arprot [get_bd_pins fsm_v3_0/s_axi_arprot] [get_bd_pins mig_7series_0/s_axi_arprot]
  connect_bd_net -net fsm_v3_0_s_axi_arqos [get_bd_pins fsm_v3_0/s_axi_arqos] [get_bd_pins mig_7series_0/s_axi_arqos]
  connect_bd_net -net fsm_v3_0_s_axi_arsize [get_bd_pins fsm_v3_0/s_axi_arsize] [get_bd_pins mig_7series_0/s_axi_arsize]
  connect_bd_net -net fsm_v3_0_s_axi_arvalid [get_bd_pins fsm_v3_0/s_axi_arvalid] [get_bd_pins mig_7series_0/s_axi_arvalid]
  connect_bd_net -net fsm_v3_0_s_axi_awaddr [get_bd_pins fsm_v3_0/s_axi_awaddr] [get_bd_pins mig_7series_0/s_axi_awaddr]
  connect_bd_net -net fsm_v3_0_s_axi_awburst [get_bd_pins fsm_v3_0/s_axi_awburst] [get_bd_pins mig_7series_0/s_axi_awburst]
  connect_bd_net -net fsm_v3_0_s_axi_awcache [get_bd_pins fsm_v3_0/s_axi_awcache] [get_bd_pins mig_7series_0/s_axi_awcache]
  connect_bd_net -net fsm_v3_0_s_axi_awid [get_bd_pins fsm_v3_0/s_axi_awid] [get_bd_pins mig_7series_0/s_axi_awid]
  connect_bd_net -net fsm_v3_0_s_axi_awlen [get_bd_pins fsm_v3_0/s_axi_awlen] [get_bd_pins mig_7series_0/s_axi_awlen]
  connect_bd_net -net fsm_v3_0_s_axi_awlock [get_bd_pins fsm_v3_0/s_axi_awlock] [get_bd_pins mig_7series_0/s_axi_awlock]
  connect_bd_net -net fsm_v3_0_s_axi_awprot [get_bd_pins fsm_v3_0/s_axi_awprot] [get_bd_pins mig_7series_0/s_axi_awprot]
  connect_bd_net -net fsm_v3_0_s_axi_awqos [get_bd_pins fsm_v3_0/s_axi_awqos] [get_bd_pins mig_7series_0/s_axi_awqos]
  connect_bd_net -net fsm_v3_0_s_axi_awsize [get_bd_pins fsm_v3_0/s_axi_awsize] [get_bd_pins mig_7series_0/s_axi_awsize]
  connect_bd_net -net fsm_v3_0_s_axi_awvalid [get_bd_pins fsm_v3_0/s_axi_awvalid] [get_bd_pins mig_7series_0/s_axi_awvalid]
  connect_bd_net -net fsm_v3_0_s_axi_bready [get_bd_pins fsm_v3_0/s_axi_bready] [get_bd_pins mig_7series_0/s_axi_bready]
  connect_bd_net -net fsm_v3_0_s_axi_rready [get_bd_pins fsm_v3_0/s_axi_rready] [get_bd_pins mig_7series_0/s_axi_rready]
  connect_bd_net -net fsm_v3_0_s_axi_wdata [get_bd_pins fsm_v3_0/s_axi_wdata] [get_bd_pins mig_7series_0/s_axi_wdata]
  connect_bd_net -net fsm_v3_0_s_axi_wlast [get_bd_pins fsm_v3_0/s_axi_wlast] [get_bd_pins mig_7series_0/s_axi_wlast]
  connect_bd_net -net fsm_v3_0_s_axi_wstrb [get_bd_pins fsm_v3_0/s_axi_wstrb] [get_bd_pins mig_7series_0/s_axi_wstrb]
  connect_bd_net -net fsm_v3_0_s_axi_wvalid [get_bd_pins fsm_v3_0/s_axi_wvalid] [get_bd_pins mig_7series_0/s_axi_wvalid]
  ...
  assign_bd_address -offset 0x413A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_26/S_AXI/Reg] -force
