...
proc create_root_design { parentCell } {
  ...
  # Create instance: fsm_01_0, and set properties
  set block_name fsm_01
  set block_cell_name fsm_01_0
  if { [catch {set fsm_01_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins fsm_01_0/din]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins fsm_01_0/valid]
  connect_bd_net -net clk_n_1 [get_bd_ports clk_n] [get_bd_pins util_ds_buf_0/IBUF_DS_N]
  connect_bd_net -net clk_p_1 [get_bd_ports clk_p] [get_bd_pins util_ds_buf_0/IBUF_DS_P]
  connect_bd_net -net fsm_01_0_led [get_bd_ports led] [get_bd_pins fsm_01_0/led]
  connect_bd_net -net fsm_01_0_ready [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins fsm_01_0/ready]
  ...
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins fsm_01_0/reset]
  ...
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins fsm_01_0/clk] [get_bd_pins util_ds_buf_0/IBUF_OUT]
